...
public class Calculator {
    ...
    public static void getMonthlyPayment(Integer principal, Float annualInterestRate, Integer numberOfYears) {
        ...
        getAllPrints(principal, annualInterestRate, monthlyPayment, realAmountPaid, numberOfMonths);

    }

    static void getAllPrints(double principal, float annualInterestRate, double monthlyPayment, double realAmountPaid, int numberOfMonths) {
        // Display the results
